...
palette_match_re = "(?P<px>\d+): (?P<rgb>.*) "
palette_match_re += "(?P<hex>#[0-9a-f]{6}) (?P<srgb>s?rgb\(\d+,\d+,\d+\))"
remove_rgb_re = "(s?rgb\(|\))"


steve_hollasch_table = {
    '153,50,204': 'orchid_dark',
    '85,107,47': 'olive_green_dark',
    '253,245,230': 'old_lace',
    '106,90,205': 'slate_blue',
    '250,235,215': 'antique_white',
    '128,42,42': 'brown',
    '135,206,250': 'sky_blue_light',
    '255,255,0': 'yellow',
    '255,99,71': 'tomato',
    '46,71,59': 'lamp_black',
    '0,255,0': 'green',
    '255,97,3': 'cadmium_orange',
    '60,179,113': 'sea_green_medium',
    '47,79,79': 'slate_grey_dark',
    '176,23,31': 'indian_red',
    '123,104,238': 'slate_blue_medium',
    '115,61,26': 'deep_ochre',
    '255,248,220': 'cornsilk',
    '64,224,208': 'turquoise',
    '0,255,127': 'spring_green',
    '255,228,196': 'bisque',
    '255,255,240': 'ivory',
    '145,33,158': 'cobalt_violetdeep',
    '139,69,19': 'saddle_brown',
    '0,0,205': 'blue_medium',
    '189,252,201': 'mint',
    '72,61,139': 'slate_blue_dark',
    '97,179,41': 'cinnabar_green',
    '252,255,240': 'titanium_white',
    '128,128,105': 'warm_grey',
    '255,160,122': 'light_salmon',
    '255,153,18': 'cadmium_yellow',
    '0,0,0': 'black',
    '210,180,140': 'tan',
    '253,248,255': 'zinc_white',
    '94,38,5': 'van_dyke_brown',
    '218,165,32': 'goldenrod',
    '46,139,87': 'sea_green',
    '10,201,43': 'permanent_green',
    '94,38,18': 'sepia',
    '189,183,107': 'khaki_dark',
    '250,128,114': 'salmon',
    '240,230,140': 'khaki',
    '160,82,45': 'sienna',
    ...
    '41,36,33': 'ivory_black',
    '240,248,255': 'alice_blue',
    '143,188,143': 'sea_green_dark',
    '250,240,230': 'linen',
    '0,191,255': 'sky_blue_deep',
    '32,178,170': 'sea_green_light',
    '70,130,180': 'steel_blue',
    '25,25,112': 'midnight_blue',
    '92,36,110': 'ultramarine_violet',
    '245,245,245': 'white_smoke',
    '107,142,35': 'olive_drab',
    '56,94,15': 'terre_verte',
    '255,250,250': 'snow',
    '143,94,153': 'violet',
    '255,182,193': 'pink_light',
    '115,74,18': 'raw_umber',
    '255,168,36': 'aureoline_yellow',
    '227,54,56': 'rose_madder',
    '176,224,230': 'powder_blue',
    '255,255,224': 'yellow_light',
    ...
    '0,250,154': 'spring_greenmedium',
    '227,23,13': 'cadmium_red_deep',
    '255,227,3': 'cadmium_lemon',
    '255,168,18': 'naplesyellowdeep',
    '255,105,180': 'hot_pink',
    '227,130,23': 'yellow_ochre',
    '255,250,240': 'floral_white',
    '227,168,105': 'melon',
    '237,145,33': 'carrot',
    '240,255,240': 'honeydew',
    '176,196,222': 'steel_blue_light',
    '255,0,255': 'magenta',
    ...
    '205,133,63': 'peru',
    '176,48,96': 'maroon',
    '219,41,41': 'brown_madder',
    '255,128,0': 'orange',
    '248,248,255': 'ghost_white',
    '34,139,34': 'forest_green',
    '219,112,147': 'violet_red_pale',
    '50,205,50': 'lime_green',
    '224,255,255': 'cyan_white',
    '219,38,69': 'permanent_violet',
    '255,61,13': 'greenish_umber',
    '212,26,31': 'venetian_red',
    '245,245,220': 'light_beige',
    '119,136,153': 'slate_grey_light',
    '227,46,48': 'madder_lake_deep',
    '188,143,143': 'rosy_brown',
    '255,245,238': 'seashell',
    '240,255,255': 'azure',
    '128,138,135': 'cold_grey',
    '227,112,26': 'mars_yellow',
    '135,66,31': 'brown_ochre',
    '0,201,87': 'emerald_green',
    '220,220,220': 'gainsboro',
    '0,255,255': 'cyan',
    '138,54,15': 'burnt_sienna',
    '244,164,96': 'sandy_brown',
    '124,252,0': 'lawn_green',
    '255,125,64': 'flesh',
    '199,97,20': 'raw_sienna',
    '154,205,50': 'yellow_green',
    '255,127,80': 'coral',
    '199,120,38': 'gold_ochre',
    '148,0,211': 'violet_dark',
    '95,158,160': 'cadet',
    '211,211,211': 'light_grey',
    '51,161,201': 'peacock',
    '147,112,219': 'purple_medium',
    '255,228,225': 'misty_rose',
    '255,0,0': 'red',
    '160,32,240': 'purple',
    '72,209,204': 'turquoise_medium',
    '199,21,133': 'violet_redmedium',
    '255,215,0': 'gold',
    '252,230,201': 'eggshell',
    '238,221,130': 'light_goldenrod',
    '238,232,170': 'goldenrod_pale',
    '250,250,210': 'goldenrod_light',
    '0,206,209': 'turquoise_dark',
    '227,18,48': 'geranium_lake',
    '152,251,152': 'green_pale',
    '0,0,128': 'navy',
    '230,230,250': 'lavender',
    '255,235,205': 'blanched_almond',
    '102,205,170': 'aquamarinemedium',
    '173,216,230': 'blue_light',
    '61,145,64': 'cobalt_green',
    '135,206,235': 'sky_blue',
    '227,38,54': 'alizarin_crimson',
    '175,238,238': 'turquoise_pale',
    '0,100,0': 'green_dark',
    '255,140,0': 'dark_orange',
    '222,184,135': 'burlywood',
    '3,168,158': 'manganese_blue',
    '245,255,250': 'mint_cream',
    '18,10,143': 'ultramarine',
    '208,32,144': 'violet_red',
    '150,69,20': 'mars_orange',
    '100,149,237': 'cornflower',
    '245,222,179': 'wheat',
    '255,3,13': 'cadmium_red_light',
    '138,43,226': 'blue_violet',
    '65,105,225': 'royal_blue',
    '255,87,33': 'flesh_ochre',
    '48,128,20': 'sap_green',
    '227,207,87': 'banana',
    ...
    '186,85,211': 'orchid_medium',
    '212,61,26': 'english_red',
    '0,199,140': 'turquoise_blue',
    '110,255,112': 'viridian_light',
    '132,112,255': 'slate_blue_light',
    '184,134,11': 'goldenrod_dark',
    '156,102,31': 'brick',
    '135,38,87': 'raspberry',
...
def avg_color(image):
    ...
    color = sp.check_output(
        ['convert', image, '-scale', ' 1x1\!',
         '-format',
...
def palette_cmy(palette):
    ...
    return [colorsys.rgb_to_hsv(1-r, 1-g, 1-b)
            for r, g, b in palette_rgb(palette, False)]
...
def palette_descriptive(palette):
    "Returns a list of descriptive names for colors by Steve Hollasch"
    return [steve_hollasch_table.get("{},{},{}".format(r, g, b))
            for r, g, b in palette_rgb(palette)]
